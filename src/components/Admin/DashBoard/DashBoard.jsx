  ...
  return (
        ...
        <Grid css={{
          cursor: `url(${Cursor}),default`}} minH={'100vh'} templateColumns={['1fr','5fr 1fr']}>
            <Box boxSizing='border-box' p={'16'} px={['4','0']}>
                ...
                <Stack direction={['column','row']} minH={'24'} justifyContent={'space-evenly'}>
                  <Databox title="Views" qty={123} qtyPercentage={23} profit={true}/>
                  <Databox title="Users" qty={23} qtyPercentage={23} profit={true}/>
                  <Databox title="Subscription" qty={20} qtyPercentage={20} profit={false}/>
                </Stack>
                <Box m={['0','16']} borderRadius={'lg'} p={['0','16']} mt={['4','16']} boxShadow={'-2px 0 10px rgba(107,70,193,0.5)'}>
                  <Heading textAlign={['center','left']} size={'md'} children='Views Graphs' pt={['8','0']} ml={['0','16']}/>
                  <LineChart/>
                </Box>
